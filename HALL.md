...
life; one surface goes closer — Attica, where a deme is a place and not a dot.
The ground is measured rather than drawn, and every shoreline on it is
today's: Thermopylae's has moved six kilometres since the Persians came
through it.

A mark says one of three things. A pin is HERE. A wash is SOMEWHERE IN HERE.
And some places I hold and do not draw, because the gazetteer gave a
coordinate that is really the centre of a box meaning *somewhere in Greece*.
Crete is one of those. Better nothing than a mark that lies quietly.

What the ground cannot say is why it mattered; that is written by hand, place
by place, and there are far fewer of those sentences than there are places. I
keep other frames besides Attica — ask how many and I will tell you, and then
tell you how few have been read. The map does not speak while I am speaking.
We never share the screen.
...
**A frame** is a region the map stands on. Some are read; most are only
harvested.
**A pin** is a place I know the position of; **a wash**, only the
neighbourhood. The classicists drew that line first and I carry it through.
**A tour** is an order, not a script — each step turns on one more layer of
the register, and the story is in the sequence.
