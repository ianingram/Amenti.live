<!-- ==========================================================================
     HEAD NOTE · added 5 September 2026

     THIS WAS `TODO.md`. It was never a to-do list, and the name was the fault:
     it reads as unfinished tasks, so nobody opened it — while two of its
     sections hold the opposite of unfinished work. CLOSED BY DECISION records
     arguments already settled, so they are not relitigated at three in the
     morning. KNOWN DEFECTS records faults knowingly accepted rather than
     pretended away. That is the kind of knowledge THE STANDING SLIP exists to
     keep, sitting in a file whose name said "ignore me".

     IT IS A SHOP-FLOOR ACCOUNT. Correct about 1 August 2026 and making NO
     claim about today. Its counts are of its own day and must not be corrected.

     WHAT BECAME OF ITS FOUR "BROKEN NOW" ITEMS, tested 5 Sep:

       1 · Hume's three philosophy texts        FIXED — all three now resolve
       2 · Shaka not in the roster              FIXED — and correctly: he is in
                                                as SHAKA ZULU with keys:["shaka"],
                                                a room and a plate, which is
                                                exactly what item 2 warned had
                                                to happen or he would appear twice
       3 · every prompt file is 404             STILL OPEN — img/prompts/ 404s.
                                                Carried into THE STANDING SLIP,
                                                where open work belongs.
       4 · amenti.py not committed              FIXED — it is at root

     The ARCHITECTURE section (items 5-9) was not re-tested and makes no claim
     about today. Read it as of 1 August.
     ========================================================================== -->
