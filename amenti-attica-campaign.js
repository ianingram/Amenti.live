  ...
  function style() {
    ...
    s.textContent = [
      ...
      /* ── MEASURED, NOT ASSUMED · 10 Sep ──────────────────────────────
         ...
         actually down there. */
      /* ── AND EVERY EDGE OF THIS SURFACE IS SPOKEN FOR · 13 Sep 2026 ──────
         The panel is centred over the frame, which at 6.97 is the Cyclades —
         and Delos, the subject of the sentence inside it. So it was moved to
         the right margin, then to the left when the right proved narrow.

         BOTH WERE WRONG AND THE SECOND WAS INVISIBLE. The left margin holds
         the key and the frames list; the right holds the register; the bottom
         holds the guide, the clock and the control row; the top right holds
         the faculty rail. THIS IS THE SAME LESSON THE PROLOGUE BUTTON LEARNED
         IN FIVE PLACEMENTS and it is written down in the handoff, where I did
         not look.

         It goes back where it was. A panel over the ground is a fault worth
         fixing; a panel nobody can see is a worse one, and the fix needs a
